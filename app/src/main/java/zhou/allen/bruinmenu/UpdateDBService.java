        ...
        protected Void doInBackground(Void... params) {
            synchronized (this) {
                try {
                    ...
                    String html = response.body().string(); Log.v("HTML: ", html);
                    ...
                    Elements menus = doc.getElementsByClass("main-content");

                    String mealTime = "";
                    for (int i = 0; i < menus.size(); i++) {
                        Element menu = menus.get(i);
                        if(menu.id() == "page-header") {
                            ...
                            for (Element kcell : kcells) {
                                ...
                                for (Element item : items) {
                                    ...
                                    if (v == null) {
                                        veg = 0;
                                    } else if (v.attr("alt").toLowerCase().contains("vg")) {
                                        veg = 2;
                                    } else if (v.attr("alt").toLowerCase().contains("v")) {
                                        veg = 1;
                                    }
